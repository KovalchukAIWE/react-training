...
import styles from './CoverPrimary.module.scss';
    ...
    return (
        <div className={styles.wrapper}>
          ...
          <div className={styles.logo}>
            ...
            <h2 className={styles.text__subtitle}>Intriguing summary goes here. Keep it short & sweet. 
            ...
            <div className={styles.link}>
                <div className={styles.link__item}>
                    ...
                    <a className={styles.link__text} href="https://kovalchukaiwe.github.io/react-training/">
                        website.com
                    </a>
                </div>
                <div className={styles.link__item}>
