        ...
        <div class='header-sticky'>
            <nav class='navigation'>
                <ul class='navigation-items'>
                    ...
                    <Link to='/bg-different-primary' class='items'>BG primary</Link>
                    <Link to='/bg-different-light' class='items'>BG light</Link>
                    <Link to='/our-mission' class='items'>Our mission</Link>
                    <Link to='/team-squares' class='items'>Team</Link>
